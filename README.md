...
```javascript
PATH_SEP_POSIX = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-path-sep-posix@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/constants-path-sep-posix@umd/bundle.js"></script>
```
