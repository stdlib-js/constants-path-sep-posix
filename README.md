...
```javascript
import PATH_SEP_POSIX from 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-path-sep-posix@v0.1.1-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/constants-path-sep-posix/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/constants-path-sep-posix/actions/workflows/test.yml?query=branch:v0.1.1
